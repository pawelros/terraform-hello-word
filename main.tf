...
resource "azurerm_app_service" "as" {
  ...
  app_settings = {
      ...
      ConnectionStrings__RContext             = "Server=${azurerm_redis_cache.redis.name}.redis.cache.windows.net:6380,password=${azurerm_redis_cache.redis.primary_access_key},ssl=True,abortConnect=False,allowAdmin=true",
